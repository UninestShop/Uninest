...
<div class="myprofile-main">
  <div class="container">
    <div class="profile-view">
        ...
        <div class="profile-right" id ="AccountSettings">
          <div class="mypro-content">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-home-tab" data-toggle="pill" data-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Change Password</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-profile-tab" data-toggle="pill" data-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Delete Account</button>
              </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <form method="POST" action="{{ route('profile.update-password') }}" class="login-form profile-form">
                  @csrf
                  @method('PUT')
                  <div class="row">
                    {{-- <div class="col-sm-12">
                    ...
                    <div class="col-sm-12 position-relative">
                      ...
                      <div class="password-wrapper position-relative">
                        ...
                        <span class="password-toggle position-absolute" onclick="toggleCurrentPassword()">
                          <i id="toggleCurrentPasswordIcon" class="fa-solid fa-eye"></i>
                        </span>
                      </div>
              ...
              <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <form id="delete-account-form" method="POST" action="{{ route('profile.delete-account') }}" class="login-form profile-form">
                  @csrf
                  @method('DELETE')
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="dlt-account">
                        <h4><svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_170_2602)"><path d="M18.1996 23.2999H6.79961C5.79961 23.2999 5.09961 22.4999 5.09961 21.5999V6.59985H19.8996V21.4999C19.8996 22.4999 19.0996 23.2999 18.1996 23.2999Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M20.8996 5.9998V4.1998C20.8996 3.4998 20.2996 2.8998 19.5996 2.8998H15.8996L15.4996 1.3998C15.2996 0.999805 14.9996 0.799805 14.4996 0.799805H10.4996C10.0996 0.799805 9.69961 0.999805 9.49961 1.3998L9.09961 2.7998H5.39961C4.69961 2.7998 4.09961 3.3998 4.09961 4.0998V5.9998C4.09961 6.2998 4.39961 6.5998 4.69961 6.5998H20.2996C20.6996 6.5998 20.8996 6.2998 20.8996 5.9998Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M9.2998 10.1997V19.6997" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.5 10.1997V19.6997" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M15.7002 10.1997V19.6997" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/></g><defs><clipPath id="clip0_170_2602"><rect width="24" height="24" fill="white" transform="translate(0.5)"/></clipPath></defs></svg> Delete Your Account?</h4>
                        <span>Warning: Deleting your account is permanent and cannot be undone. All your data, including profile information and product listings, will be permanently removed.</span>
                      </div>
                    </div>
                  </div>
                  <button type="button" class="btn btn-primary dlt-btn" id="delete-account-btn">
                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_170_2602)"><path d="M18.1996 23.2999H6.79961C5.79961 23.2999 5.09961 22.4999 5.09961 21.5999V6.59985H19.8996V21.4999C19.8996 22.4999 19.0996 23.2999 18.1996 23.2999Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M20.8996 5.9998V4.1998C20.8996 3.4998 20.2996 2.8998 19.5996 2.8998H15.8996L15.4996 1.3998C15.2996 0.999805 14.9996 0.799805 14.4996 0.799805H10.4996C10.0996 0.799805 9.69961 0.999805 9.49961 1.3998L9.09961 2.7998H5.39961C4.69961 2.7998 4.09961 3.3998 4.09961 4.0998V5.9998C4.09961 6.2998 4.39961 6.5998 4.69961 6.5998H20.2996C20.6996 6.5998 20.8996 6.2998 20.8996 5.9998Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M9.2998 10.1997V19.6997" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.5 10.1997V19.6997" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M15.7002 10.1997V19.6997" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/></g><defs><clipPath id="clip0_170_2602"><rect width="24" height="24" fill="white" transform="translate(0.5)"/></clipPath></defs></svg> Delete My Account
                  </button>
                </form>
              </div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="{{ route('profile.settings') }}" class="btn btn-primary">Cancel</a>

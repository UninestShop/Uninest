    ...
    <div class="container">
        <div class="profile-view">
            <div class="profile-left">
                <div class="profile-top">
                    ...
                    <ul class="profile-list">
                        ...
                        <li><a href="{{ route('seller.products','#mypro-content') }}" class="pro-links active {{ request()->routeIs('seller.products.index') ? 'active' : '' }}"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="profile-right">
                ...
                @endif
                <div class="mypro-content" id="mypro-content">
                    <div class="row mb-4">
                        <div class="col-md-8 top-head">
                            <h2>Current Selling</h2>
                        </div>
                        <div class="col-md-4 text-right">
                            {{-- @if(intval($productLimit) >= $stats['total']) --}}
                                <a href="{{ route('seller.products.create') }}" class="btn btn-primary">
                                    <i class="fas fa-plus"></i> Sell More Product(s)
                                </a>
                            {{-- @else --}}
                                {{-- <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#limitReachedModal">
                                    <i class="fas fa-plus"></i> Sell More Product(s)
                                </button>
                            @endif --}}
                        </div>
                    ...
                    <!-- Product Limit Warning Alert -->
                    <div class="alert alert-warning mb-4">
                        <div class="d-flex align-items-center">
                            <i class="fas fa-exclamation-triangle fa-2x mr-3"></i>
                            <div>
                                <h5 class="alert-heading mb-1">Product Limit Reached</h5>
                                <p class="mb-0">You've reached your maximum limit of {{ $productLimit }} products. Please contact admin if you need to list more products.</p>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <!-- Product Limit Modal -->
                    {{-- <div class="modal fade" id="limitReachedModal" tabindex="-1" role="dialog" aria-labelledby="limitReachedModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-warning">
                                    <h5 class="modal-title" id="limitReachedModalLabel">Product Limit Reached</h5>
                                ...
                                <div class="modal-body">
                                    <div class="text-center mb-4">
                                        ...
                                        <h5>You've reached your product limit!</h5>
                                    </div>
                                    <p>You currently have <strong>{{ $stats['total'] }}</strong> products listed, which is the maximum allowed ({{ $productLimit }} products).</p>
                                    <p>To list more products, you have a few options:</p>
                                    <ul>
                                        <li>Delete or mark as sold some of your current listings</li>
                                        <li>Contact the administrator to request a higher limit</li>
                                        <li>Wait until some of your current products are sold</li>
                                    </ul>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <a href="mailto:admin@example.com?subject=Product%20Limit%20Increase%20Request&body=I%20would%20like%20to%20request%20an%20increase%20in%20my%20product%20limit.%20Currently%20I%20have%20{{ $stats['total'] }}%20products%20listed." class="btn btn-primary">
                                        Contact Admin
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="current-sale">
                        ...
                        @forelse($products as $product)
                            ...
                            <a href="{{ route('seller.products.edit', $product) }}#editmyproducts" class="edit-profile" id="editProfileBtn"><img src="{{ asset('images/edit-icon.svg') }}" alt="edit-icon"></a>

                            <!-- Replace the anchor tag with a proper form for delete -->
                            <form action="{{ route('seller.products.destroy', $product) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="delete-mode btn-link p-0 border-0 bg-transparent" data-toggle="modal" data-target="#deleteModal{{ $product->id }}">
                            ...
                            <div class="item-content">
                                ...
                                <form action="{{ route('seller.products.mark_sold', $product) }}" method="POST" class="d-inline">
                                    @csrf
                                    <button type="submit" class="btn btn-secondary sold-out">Mark as Sold</button>
                                </form>
                            </div>
                            </li>
                        @empty
...
<div class="modal fade" id="logoutModal" tabindex="-1" aria-labelledby="logoutModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="{{ route('seller.products') }}" class="btn btn-primary">Cancel</a>
